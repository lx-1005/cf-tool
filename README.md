...
[![license](https://img.shields.io/badge/license-MIT-%23373737.svg)](https://raw.githubusercontent.com/dianhsu/cf-tool/master/LICENSE)
...
You can download the pre-compiled binary file in [here](https://github.com/dianhsu/cf-tool/releases).
...
```plain
$ go get github.com/dianhsu/cf-tool
$ cd $GOPATH/src/github.com/dianhsu/cf-tool
 ...
 * You can download the binary file in here https://github.com/dianhsu/cf-tool (Windows, macOS, Linux)
 * Author: $%U%$
 * Time: $%Y%$-$%M%$-$%D%$ $%h%$:$%m%$:$%s%$
**/
